...
PREFIXES = {
    ...
    # …and «Гонка вооружений» (#2579), whose six phase pictures the card's «i» draws.
    # They are filed in two trees: the small icons among the screen's own sprites, the
    # phase pictures under TextureEx beside it.
    "arms": "Assets/Main/Sprites/UI/UIPersonalArms",
