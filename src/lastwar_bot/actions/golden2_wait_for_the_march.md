# Wait for the chosen squad's own march to land — one brick of the golden-zombie chain. (the second squad)
# ru: Дождаться, пока марш выбранного отряда дойдёт — кирпич цепочки золотых зомби. (второй отряд)
#
...
#
# The state it works on lives in the game VM (`DataCenter.__lw_gold2`), parked there by
