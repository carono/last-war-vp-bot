...
# attacks, and the event window's own panel get for the two reward lists. The second is
# why the chests can be counted at all — the lists are not there until something asks,
# exactly as the boss is not.
#
