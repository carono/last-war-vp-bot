# Let the chosen zombie go. Nothing is sent, and the registry is kept. (the second squad)
# ru: Забыть выбранного зомби. Ничего не отправляется, реестр остаётся. (второй отряд)
#
