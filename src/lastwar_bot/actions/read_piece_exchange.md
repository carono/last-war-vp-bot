...
#
# The verdict is the operator's own rule (#1975), in their words: «выгодный, если у нас
# меньше или столько же тех, что нам предлагают» — take an offer when we hold NO MORE of
# the piece it gives us than of the piece it asks us for. `strict = 1` turns the «≤» into
# a «<» and refuses an even swap. Same argument, same default as the errand's, so the two
# can never disagree about the same board.
