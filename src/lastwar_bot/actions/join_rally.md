...
# THE SOLDIER FLOOR, AND IT IS CHECKED BEFORE EVERY SQUAD-SHAPED ENDING (#1317). `-5`
# says there are fewer soldiers standing in the base than the number set in «Автостяг»,
