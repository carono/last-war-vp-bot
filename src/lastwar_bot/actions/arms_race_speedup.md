...
LUA DataCenter.__lw_arms_sp = {cap = (tonumber("{minutes}") or 0) * 60, spent = 0, sends = 0, own_num = 0, own_sec = 0, uni_num = 0, uni_sec = 0, kinds = {}, sc0 = -1, paid = 1, why = 'nothing tried'}
