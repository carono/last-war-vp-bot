...
WHILE go == 1 LIMIT 200
    CALL golden_wait_for_the_march
    IF go == 1
...
IF reaimable == 0
    READ_LUA (function() local p = DataCenter.__lw_gold or {} p.judge = p.judge or p.hit DataCenter.__lw_gold = p return 1 end)() INTO last_judged
    CALL golden_judge_the_kill
