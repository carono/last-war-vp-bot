# Judge whether the zombie we hit is gone — one brick of the golden-zombie chain. (the second squad)
# ru: Решить, исчез ли зомби, по которому били, — кирпич цепочки золотых зомби. (второй отряд)
#
