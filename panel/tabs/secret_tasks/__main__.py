...
A window holding just this one starts the capture, the auto-loot watcher and the map
sweep the profile asked for — the standing orders are the tab's, not the shell's.
"""
