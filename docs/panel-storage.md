...
|---|---|---|---|
| resources gained | `blobs` `resource_stats`, and `resource_stats_base` beside it (`panel/resource_stats.py`) | `{date: {food, metal, oil, gold}}`, a new key a day | day key is the **GAME's** since #2743; older rows keep the PC date they were written under |
